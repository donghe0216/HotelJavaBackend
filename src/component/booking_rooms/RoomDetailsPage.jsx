...
const RoomDetailsPage = () => {
  ...
  const acceptBooking = async () => {
    ...
    try {
      ...
      if (resp.status === 200) {
        setConfirmedBooking(resp.booking);
  ...
  return (
    <div className="room-details-booking">
      ...
      {/* Booking Confirmed — Bill Summary + Pay Now */}
      {confirmedBooking && (
        <div className="booking-preview">
          <h3>Booking Confirmed!</h3>
          <p><strong>Booking Reference:</strong> {confirmedBooking.bookingReference}</p>
          ...
          <p><strong>Payment Status:</strong> {confirmedBooking.paymentStatus}</p>
          <button
            className="book-now-button"
            onClick={() => navigate(`/payment/${confirmedBooking.bookingReference}/${confirmedBooking.totalPrice}`)}
          >
            Proceed to Payment
          </button>
          <button
